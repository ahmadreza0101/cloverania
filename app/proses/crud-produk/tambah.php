            ...
            <div class="col-lg-10">
                <div class="mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0 small">Masukkan aset digital baru ke Cloverania Store.</p>
                    </div>
                </div>
...
function initTambahPage() {
    ...
    formTambah.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            showOverlay('Menyimpan data produk ke database...');

            window.removeEventListener('beforeunload', beforeUnloadHandler);

            HTMLFormElement.prototype.submit.call(formTambah);
        } catch (err) {
            window.removeEventListener('beforeunload', beforeUnloadHandler);
            hideOverlay();
