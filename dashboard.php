        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <p class="text-light mb-0">
                            <i class="bi bi-envelope-fill me-2 text-secondary"></i><?= htmlspecialchars($user['email'] ?? '-') ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <a href="/produk.php" class="dashboard-menu-card">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="text-muted small mb-0">Tambah, edit, atau hapus produk digital</p>
                                </div>
                            </div>
                        </a>
                    </div>
